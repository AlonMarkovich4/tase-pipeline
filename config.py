...
# Portfolio capital — single source of truth for percentage framing in the
# weekly summary. The % is computed on a SINGLE-LOT basis: pct =
# potential_total / PORTFOLIO_CAPITAL * 100 (one lot per expiry against a
# 20,000 ₪ book).
